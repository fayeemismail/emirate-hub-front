...
export default function ServicesList() {
  ...
  return (
    <section className="py-16 md:py-24 bg-[#F2F3EE]/60 overflow-hidden">
      <div className="site-container">
        {/* Category Pills Navigation Bar */}
        <div className="mb-14 md:mb-20">
          <div className="flex items-center justify-start lg:justify-center overflow-x-auto pb-3 gap-2.5 sm:gap-3.5 no-scrollbar">
            {servicesData.map((service) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 sm:px-5 py-2.5 rounded-full text-xs sm:text-sm font-semibold tracking-wider whitespace-nowrap transition-all duration-300 border cursor-pointer select-none ${
                    isActive
          ...
          {servicesData.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                id={service.id}
                className={`scroll-mt-28 md:scroll-mt-32 rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 transition-all duration-500 ${
                  isTargeted
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
                  ...
                  >
                    ...
                    {/* Title */}
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 tracking-tight leading-tight mb-4">
                      {service.title}
                    </h2>
                ...
                {index !== servicesData.length - 1 && (
                  <div className="w-full h-px bg-gray-300/60 mt-16 md:mt-24" />
                )}
              </div>
            );
          })}
